...
%
    \parbox{\textwidth}{% To prevent line-breaking in this block.
        ...
        $if(signature)$
        Sincerely,\\
        \hbox{\hspace{1cm} \includegraphics[width=6em]{signature/sign.pdf}} \\
        $else$
        \vspace{3cm}
        $endif$
        \textbf{Clément Aubert}, Ph.D.\\
        Assistant Professor in Computer Science\\
        t: 706 737 1566\\
        \href{mailto:caubert@augusta.edu}{caubert@augusta.edu}\\
        \href{https://spots.augusta.edu/caubert/}{spots.augusta.edu/caubert}
...
\hypersetup{
	pdfinfo={
		Title={Letter from Clément Aubert, Augusta University.},
		$if(subject)$
		Subject={$subject$},
		$endif$
